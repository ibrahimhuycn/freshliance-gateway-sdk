...
/// <summary>
/// Response DTO representing the sensor configuration within a template,
/// including start delay, collection interval, category, and template name.
/// </summary>
public class TemplateSensorConfigResponse
{
    /// <summary>
